package com.dalingge.gankio.common.widgets.recyclerview.utils;
...
import com.dalingge.gankio.common.widgets.recyclerview.refresh.LoadingFooter;


/**
 * FileName: RecyclerViewUtils
 * description:分页展示数据时，RecyclerView的FooterView State 操作工具类
